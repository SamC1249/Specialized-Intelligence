...
from specint.licenses import classify as classify_license
...
def _coerce_license(short_name: str | None, url: str | None = None):
    return classify_license(short_name, url)
